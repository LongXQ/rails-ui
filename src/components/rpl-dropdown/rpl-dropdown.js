        ...
        this.contentSlotRef = createRef(),
            ...
            this.handleDocumentClick = e => {
                if (!(e.target instanceof HTMLElement) || this.hidden)
                    return;
                this.eventUsedMap.has(e) || o.a2(this, e.target) || this.hide()
            }
            ,
    ...
    render() {
        return html`
            <sl-popup part="popper" exportparts="popup:popper--popup,arrow:popper--arrow"
                ...
                <slot name="anchor" slot="anchor" aria-describedby="hovercard" @click="${this.interactionController.handleClick}"
